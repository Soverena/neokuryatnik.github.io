(function(g, h, A) {
    ...
    function vb(a, b, c, d, f) {
        ...
        function Q(a) {
            ...
            P && (d |= 2);
            a: {
                var w = p.getElementChildren(p.getElementParent(a), a.tagName);
        ...
        function r(a, b, c, d, f, e) {
            for (var q; c && (q = p.getElementSize(c)) && (!q[0] || !q[1]); )
                c = p.getElementParent(c);
            if (!c)
                return null;
            q = c[F];
            if (!q || 0 > q)
            ...
            /^mouse(up|down)|click$/.test(b) && (a = f || e,
            m(c, 2 > a ? 1 : a == (f ? 2 : 4) ? 4 : 2));
            return c
        }
        function zb(a, b, c, d) {
            b = b[F];
        ...
        function Ab(a, b) {
            ...
            if (0 == b.length)
                ...
                100 >= b.length ? (c = b,
                d = "") : 200 >= b.length ? (c = b.substr(0, 100),
                d = b.substr(100)) : (c = b.substr(0, 97),
                d = b.substr(b.length - 97));
            var f = [];
            m(f, 29);
            k(f, a);
            t(f, c);
        ...
        function E(a) {
            var b = a[F];
            if (!b || 0 > b || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || R(a.form))
                return null;
                    ...
                    if (b[F])
                        ...
                        if (c) {
                            ...
                            for (var d = c.length, f = 0; f < d; f++)
                                /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[f].tagName) && !c[f][F] && O(c[f])
                        } else
                            O(b)
                    }
                else
        ...
        function D(a) {
            ...
            if (!(10 > c)) {
                var d = B.getPos(a)
                  ...
                  , m = $a[1] - d[1];
                f = f * f + m * m;
                0 >= f || 16 > f && 100 > c || 20 > c && 256 > f || (ib = b,
                $a = d,
                M(a))
            }
        }
        function ea() {
            var a = p.getDocumentScroll()
              , b = n.nowTime();
            10 > b - jb || 10 > Math.abs(a[0] - ab[0]) && 10 > Math.abs(a[1] - ab[1]) || (jb = b,
            ab = a,
            G(Aa, [n.nowEventTime(), a]))
        }
        function da(a) {
            if (a = B.getTarget(a)) {
                var b = Math.random()
        ...
        function ka(a, b, c) {
            a = B.getTarget(a);
            var d = I(a);
            d.ignore || !d.forceRecord && (d.isPrivate && f.get("isEU") || N(a)) || (O(a),
            G(A, [n.nowEventTime(), b, c, a, d.privateFlag]))
        }
        function ma(a) {
            var b = a.keyCode
              , c = na(a);
        ...
        function oa(a) {
            la && !cb && 0 !== a.which && (ka(a, a.charCode || a.keyCode, na(a)),
            cb = !0,
            e.setTimeout(function() {
                cb = !1
            }, 1, "vwl.keyPress"))
        ...
        function X() {
            if (g.getSelection) {
                ...
                h.selection && h.selection.createRange && (a = h.selection.createRange(),
                b = a.text,
                c = a.parentElement());
            if ("string" == typeof b) {
                try {
                ...
                if (c) {
                    ...
                    for (var d = 0; d < c.length && !a; )
                        a = I(c[d]).privateFlag || N(c[d], !0),
                        d++;
                    b != db && (db = b,
                    b = a ? e.map(function() {
                        return Fa.obfuscatedSymbol
                    }, b.split("")).join("") : b,
                    G(Ab, [n.nowEventTime(), b]))
                }
            }
        }
        function aa() {
            eb || (eb = !0,
            db && G(Ba, [n.nowEventTime()]),
            e.setTimeout(function() {
                eb = !1
            }, 1, "wvl.copy"))
        }
                ...
                if (a[F])
                    ...
                    if (b) {
                        ...
                        for (var c = b.length, d = 0; d < c; d++)
                            /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][F] && O(b[d])
                    } else
                        O(a)
                }
        ...
        function w(a) {
            (a = B.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (O(a),
            G(y, [n.nowEventTime(), a]))
        }
        function J(a) {
            if ((a = B.getTarget(a)) && !ja(a) && !N(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var b = I(a)
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != h) {
                    ...
                    for (var c = 0; c < a.touches.length; c++)
                        G(r, [n.nowEventTime(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        function S(a) {
            ...
            if (b) {
                ...
                c && (O(b),
                G(zb, [n.nowEventTime(), b, B.getPos(a), c]))
            }
        }
        function qa(a) {
        ...
        if (!e.isMetrikaPlayer()) {
            ...
            if (lb)
                l.on(h, "mouseleave", qa);
            h.attachEvent && !g.opera ? (l.on(h, "focusin", ca),
            l.on(h, "focusout", fa)) : (l.on(g, "focus", T),
            l.on(g, "blur", pa),
            l.on(h, "blur", pa));
            h.addEventListener ? (l.on(h, "scroll", da),
            l.on(h, "focus", P),
            l.on(h, "blur", w),
            l.on(h, "change", J),
            l.on(h, "submit", W)) : h.attachEvent && (l.on(h, "focusin", P),
            l.on(h, "focusout", w),
            function() {
            ...
            "0:0" !== p.getDocumentScroll().join(":") && ea();
            U()
        }
        return {
            start: function() {
            ...
            stop: function() {
                ...
                l.un(g, "blur", pa);
                l.un(h, "blur", pa);
                h.removeEventListener ? (l.un(h, "scroll", da),
                l.un(h, "focus", P),
                l.un(h, "blur", w),
                l.un(h, "change", J),
                l.un(h, "submit", W)) : h.detachEvent && (l.un(h, "focusin", P),
                l.un(h, "focusout", w),
                function() {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                        for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++)
                            /^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName) && l.un(c[d], "change", J);
                        l.un(a[b], "submit", W)
                    }
                }());
                (function() {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++)
                        a[b][ha] && (a[b].submit = a[b][ha])
                }
                )()
            },
            uploadPages: function(a, b) {
                ...
                var d = this;
                "complete" === h.readyState ? c() : (l.on(h, "DOMContentLoaded", c),
                l.on(g, "load", c))
            },
            uploadPage: u(function(f) {
                ...
                if ("html" === f)
                    return f = new RegExp("\x3cscript [^\x3e]*?//" + C.host.replace(/\./g, "\\\\.") + "/watch/.*?\x3c/script\x3e","gi"),
                    x.sendContent(p.getDocumentHTML().replace(f, ""), q, d, Ha, Ia),
                    !0;
                e && (e.open("get", z().href, !0),
                e.onreadystatechange = u(function() {
                    if (4 === e.readyState) {
                ...
                e.overrideMimeType && k && e.overrideMimeType(q),
                e.send(null));
                return !0
            }, "uploadPage")
        }
    ...
    function z() {
        for (var a = {}, b = "hash host hostname href pathname port protocol search".split(" "), c = b.length, d = c, f, e; d--; )
            a[b[d]] = "";
        try {
            for (f = g.location,
            d = c; d--; )
    ...
    function Fb(a) {
        var b = [], c = a._lastPerformanceTiming, d = ob(), f;
        if (c) {
            var e = 0;
    ...
    function Hb() {
        ...
        if ("object" == typeof g.chrome && g.chrome.loadTimes) {
            if (b = g.chrome.loadTimes(),
            b.requestTime && b.firstPaintTime && g.performance && g.performance.timing)
                return Math.round(1E3 * b.firstPaintTime - g.performance.timing.navigationStart)
        } else if (g.performance && g.performance.timing && (b = g.performance.timing,
        ...
        , function(a, b) {
            ...
            b.hash = function(a, b) {
                ...
                var q = (a = a || "").length % 16
                  ...
                  , h = [0, b];
                b = [0, b];
                for (var l, x, t = [2277735313, 289559509], p = [1291169091, 658871167], n = 0; n < m; n += 16)
                    l = [255 & a.charCodeAt(n + 4) | (255 & a.charCodeAt(n + 5)) << 8 | (255 & a.charCodeAt(n + 6)) << 16 | (255 & a.charCodeAt(n + 7)) << 24, 255 & a.charCodeAt(n) | (255 & a.charCodeAt(n + 1)) << 8 | (255 & a.charCodeAt(n + 2)) << 16 | (255 & a.charCodeAt(n + 3)) << 24],
                    x = [255 & a.charCodeAt(n + 12) | (255 & a.charCodeAt(n + 13)) << 8 | (255 & a.charCodeAt(n + 14)) << 16 | (255 & a.charCodeAt(n + 15)) << 24, 255 & a.charCodeAt(n + 8) | (255 & a.charCodeAt(n + 9)) << 8 | (255 & a.charCodeAt(n + 10)) << 16 | (255 & a.charCodeAt(n + 11)) << 24],
                    l = f(l = c(l, t), 31),
                    h = d(h = f(h = g(h, c(l, p)), 27), b),
                    h = d(c(h, [0, 5]), [0, 1390208809]),
                    x = f(x = c(x, p), 33),
                    b = d(b = f(b = g(b, c(x, t)), 31), h),
                ...
                case 12:
                    x = g(x, e([0, a.charCodeAt(n + 11)], 24));
                case 11:
                    x = g(x, e([0, a.charCodeAt(n + 10)], 16));
                case 10:
                    x = g(x, e([0, a.charCodeAt(n + 9)], 8));
                case 9:
                    x = c(x = g(x, [0, a.charCodeAt(n + 8)]), p),
                    b = g(b, c(f(x, 33), t));
                case 8:
                ...
                case 1:
                    l = c(l = g(l, [0, a.charCodeAt(n)]), t),
                    h = g(h, c(f(l, 31), p))
                }
                return h = d(h = g(h, [0, a.length]), b = g(b, [0, a.length])),
                b = d(b, h),
                h = d(h = k(h), b = k(b)),
                b = d(b, h),
                ("00000000" + (h[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (h[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
            }
        }
        ]);
        wa = wa["default"]
    ...
    var l = E.inherit({
        ...
        on: function(a, b, c, d, f) {
            f = l._getOpts(f);
            b = b.split(",");
            var e = b.length, m = this._listeners, k;
            for (k = 0; k < e; k++) {
                var h = b[k];
                var n = u(function(a) {
        ...
        un: function(a, b, c, d, f) {
            f = l._getOpts(f);
            var g = this._listeners, m = g.length, k;
            for (k = 0; k < m; k++) {
                var h = g[k];
    ...
    var n = {
        ...
        getMs: function() {
            return 0 < this.UNLOAD_MS ? this.UNLOAD_MS : this.isPerfomance ? Math.round(g.performance.timing.navigationStart + g.performance.now()) : n.oldMs()
        },
    ...
    ;
    n.isPerfomance || (n.deltaTime = 0,
    n.lastNowTime = 0,
    n.correctTime = 0,
    n.timeCorrector = function(a) {
    ...
    e.async = function(a, b, c) {
        if (g.postMessage) {
            ...
            var f = function(c) {
                ...
                e === d && (c.stopPropagation && c.stopPropagation(),
                a.call(b),
                l.un(g, "message", f, null, {
                    passive: !1
                }))
            };
    ...
    ja.stringify = function(a, b) {
        var c = [], d = b || {}, f = {}, g = e.keys(a).length, m, k;
        if (d.lastOrdering !== A)
            for (k = 1; k <= b.lastOrdering.length; k++)
                f[b.lastOrdering[k - 1]] = g + k;
        if (d.firstOrdering !== A)
            for (k = 0; k < b.firstOrdering.length; k++)
                f[b.firstOrdering[k]] = k;
        for (m in a)
            if (a.hasOwnProperty(m))
                ...
                e.isArray(d))
                    ...
                    c.push({
                        key: m,
                        value: encodeURIComponent(m) + "\x3d" + encodeURIComponent(String(d))
                    });
        c.sort(function(a, b) {
            var c = f[a.key]
              , d = f[b.key];
    ...
    var T = E.inherit({
        ...
        _buildUrl: function(a, b) {
            var c = ja.stringify(b, this.queryStringParams);
      ...
      , ra = T.inherit({
        ...
        request: function(a, b, c, d) {
            ...
            if (/[^a-z0-9.:-]/.test(L.host) && g.opera && "function" === typeof g.opera.version) {
                ...
                if ("string" === typeof m && "12" === m.split(".")[0])
                    return c.call(d, !1)
            }
            if (g.XMLHttpRequest) {
    ...
    var Ib = T.inherit({
        ...
        index: 1,
        request: function(a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !r.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b),
            b.get["force-urlencoded"] = 1,
            c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), ja.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    e.toJSON = function(a) {
        ...
        case Array:
            ...
            for (b = a.length; d < b; d++)
                c[c.length] = e.toJSON(a[d]);
            return "[" + c.join(",") + "]";
        case Object:
            c = [];
            for (d in a)
                a.hasOwnProperty(d) && a[d] !== A && (c[c.length] = e.toJSON(d) + ":" + e.toJSON(a[d]));
            return "{" + c.join(",") + "}";
        default:
    ...
    var M = E.inherit({
        ...
        getStorageId: function() {
            var a = this.get("lsid");
            a || (a = Math.round(Math.random() * n.getMs()),
            this.set("lsid", a));
            return a
        },
    ...
    r.isFF = u(function(a) {
        var b = !1;
        g && g.document && g.document.documentElement && g.document.documentElement.style && (b = "MozAppearance"in g.document.documentElement.style && "undefined" !== typeof g.InstallTrigger);
    ...
    var ka = {
        ...
        initPU: function(a, b) {
            var c = this
              , d = r.isFF(68);
            b.get("pu") !== A || this.checkVersion() && !d || (this.globalConfig = b,
            b.setSafe("pu", null),
            ...
            g.opener ? (e.setTimeout(function() {
                c.genPu(b)
            }, 200, "pu"),
        ...
        onicecandidate: u(function(a) {
            ...
            c && 0 < c.length && (this.pp = e.fnv32a(c[1]),
        ...
        initPP: u(function(a) {
            ...
            this.globalConfig = a;
            if (g.navigator.onLine && b && a.get("pp") == A && (this.globalConfig.setSafe("pp", null),
        ...
        initZZ: function() {
            ...
            b.src = C.protocol + "//" + C.baseUrl + a + N.decode(C.cross),
      ...
      , K = xa.inherit({
        ...
        _sendSavedRequest: function(a, b, c, d, f) {
            var g = this.globalConfig.get("firstReqStatus")
              , m = b.forceNoRedirect;
            if ("process" == g)
                this.globalConfig.set("firstReqCallbacks", e.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [[this, arguments]]));
            else {
    ...
    K.initCookie = function(a) {
        ...
        if (!c)
            ...
            b.create(a, c, 525600),
            b.create("d", m, 525600);
        else if (!g || 15768E3 < m - parseInt(g))
            b.create(a, c, 525600),
            b.create("d", m, 525600);
        K._storage.set(a, c);
        K._userID = c;
    ...
    K.retransmit = function(a) {
        var b = K._storage, c = b.get("retryReqs") || {}, d;
        b.remove("retryReqs");
        e.forEachKey(c, function(b, c) {
            var f = n.getMs();
            a.get("firstReqStatus") || a.set("firstReqStatus", "complete");
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 1728E5 > f && 500 < f - c.time && 2 >= c.browserInfo.rqnl && (d = new K({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    ;
    N.encode = function(a, b) {
        var c = (N.abc + (b ? N.tailSafe : N.tail)).split(""), d = a.length, f = [], g = d - d % 3, m;
        for (m = 0; m < g; m += 3) {
        ...
        case 2:
            k = (a[g] << 10) + (a[g + 1] << 2),
            e.mergeArrays(f, [c[k >> 12 & 63], c[k >> 6 & 63], c[k & 63], c[64]])
        }
        return f.join("")
    }
    ;
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            ...
            if ((b = b.description) || c)
                ...
                "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin)
                    c ? r._flashVersion = c : b && (r._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
        } else if ("undefined" != typeof g.ActiveXObject)
            try {
                if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
                b = c.GetVariable("$version"))
                    r._flashVersion = b.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g, "")
            } catch (d) {}
    ...
    r.isSelenium = e.memorize(function() {
        ...
        for (c = 0; c < f.length; c++)
            if (d && d[f[c]])
                return !0;
        if (g.external && g.external.toString && 0 <= g.external.toString().indexOf("Sequentum"))
            return !0;
    ...
    var pb = {
        ...
        _send: function() {
            ...
            l.ready(function() {
                ...
                r.isSafari() && (b.style.position = "absolute",
                b.style.visibility = "hidden",
                b.style.width = "0px",
                b.style.height = "0px",
      ...
      , Ta = {
        ...
        decode: function(a) {
            for (var b = "", c = 0, d, f, e; c < a.length; )
                ...
                e = a.charCodeAt(c + 2),
                b += String.fromCharCode((d & 15) << 12 | (f & 63) << 6 | e & 63),
                c += 3);
            return b
        }
    };
    N.decode = function(a, b) {
        for (var c = N.abc + (b ? N.tailSafe : N.tail), d = 0, f = "", e, g, k, h, l; a.length % 4; )
            a += "\x3d";
        do {
    ...
    var la = K.inherit({
        ...
        paramsQueue: {
            ...
            mixin: function(a) {
                var b = {};
                this.paramsQueue.length && (b = e.reduce(this._reduce(e.keys(a)), {}, this.paramsQueue),
        ...
        _hitExt: function(a, b) {
            ...
            if (!e.isMetrikaPlayer()) {
                ...
                var p = {};
                a.nohit && c("nohit", 1);
                k.ar && !k.onlyData && (l = null === l || "" === l ? "" : this._prepareHitUrl(l),
                n = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", e.trim(l, Ka));
                c("page-url", e.trim(n, Ka));
                e.is4Bytes(a.title) && c("charset", "utf-8");
                -1 != z().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", fb) : "undefined" != typeof k.ut && c("ut", e.trim(k.ut, Kb));
                c("exp", a.experiments);
                (f = a.vParams) && this.counter && f.__ym && (e.isNumber(f.__ym.turbo_page) && (this.counter.tp = f.__ym.turbo_page),
                e.isNumber(f.__ym.turbo_page_id) && (this.counter.tpid = f.__ym.turbo_page_id));
                (!f || e.isObject(f) && !f.__ym && !f.__ymu) && this.paramsQueue.length() && e.inArray(["go", "hit", "pa"], b) && (f = this.paramsQueue.mixin(f));
                f && (n = e.toJSON(f),
                this.trimParams && n.length > Lb ? g = !0 : n > C.maxBodyLength ? e.warning("Too big params") : c("site-info", n));
        ...
        _getTechInfo: function(a, b, c, d, f, h, m, k, l, t) {
            ...
            V && q("s", V.width + "x" + V.height + "x" + (V.colorDepth || V.pixelDepth));
            g.devicePixelRatio && q("sk", g.devicePixelRatio);
            r.isSelenium() && q("iss", "1");
            r.isHeadLess() && q("hdl", "1");
            r.isIframe() && (q("ifr", "1"),
            q("sti", r.isSameOriginTopFrame() ? "1" : "0"));
            ...
            t || (d ? d++ : d = 1),
            f.set("reqNum", d),
            f.get("reqNum") == d ? (q("ls", c),
            q("rqn", d)) : (f.remove("reqNum"),
            f.clearStorageId(),
            1 < d && (q("ls", c),
            q("rqn", 0))));
            q("rn", e.random());
            ...
            l._firstPaint || t || (l._firstPaint = Hb(),
            q("fp", l._firstPaint));
            if (k) {
    ...
    p.getElementXY = function(a) {
        var b;
        if (!a || !a.ownerDocument || "PARAM" == a.tagName || a == p.getBody() || a == h.documentElement)
            return [0, 0];
    ...
    p.getElementsByClassName = function(a, b) {
        ...
        for (c = 0; c < d.length; c++)
            p.classNameExists(d[c], a) && f.push(d[c]);
        return f
    }
    ;
      ...
      , qb = E.inherit({
        ...
        start: function(a) {
            ...
            if (this.isEnabled() && this._recorder) {
                ...
                c = a.arch_type,
                (a = a.urls) && c && "none" !== c && this._recorder.uploadPages(a, c)) : this._recorder.stop()
            }
        },
        stop: function() {
    ...
    xa = T.inherit({
        ...
        request: function(a, b, c, d) {
            ...
            k || (k = h.createElement("head"),
            h.documentElement.appendChild(k));
            e.async(function() {
    ...
    var La = ra.inherit({
      ...
      , gb = la.inherit({
            ...
            if (a) {
                a: {
                    if (a = e.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                        ...
                        -1 != e.arrayIndexOf(C.yandexWhiteListTld, a))
                            break a;
                    a = !1
                }
        ...
        sendHit: function(a) {
            ...
            b.ilt = N.encode(Ta.encode(e.trim(c, rb))));
      ...
      , Ma = E.inherit({
        ...
        hit: function(a, b) {
            ...
            f && f.params && f.time + 864E5 > n.getMs() ? (c.globalConfig.set("isEU", f.params.eu),
      ...
      , sb = E.inherit({
        ...
        _initComponent: function() {
            ...
            e.forEachKey(this.partners, function(a, c) {
                c.regex.test(g.location.hostname) && (this.syncTlds[c.tld] || (this.syncTlds[c.tld] = []),
    ...
    var ha = {
      ...
      , Ob = {
        ...
        _enabled: function(a, b, c) {
            if (!(60 < n.getMinutes() - ha.getNum("ds")) || this._is() || e.isDev(this.globalConfig))
                return !1;
        ...
        getTarget: function(a) {
            ...
            try {
                if (b = a.target || a.srcElement)
                    !b.ownerDocument && b.documentElement ? b = b.documentElement : b.ownerDocument !== h && (b = null)
            } catch (c) {}
            return b
        },
    ...
    B.dispatchCustomEvent = u(function(a, b) {
        ...
        if (c = e.getNativeFunction("createEvent", h)("Event"))
            c.initEvent(a, !1, !1),
            e.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Ua = {
        lastReferrer: null
    }
      , ma = E.inherit({
        ...
        initUserLayer: function() {
            ...
            if (this.prefsEcommerce || this.prefsUseDataLayer)
                this._overridePush(this.prefsEcommerce) || (e.isString(this.prefsEcommerce) && (this.dataLayerName = this.prefsEcommerce),
            ...
            for (f = a.length; h < f; h++) {
                if ((d = a[h]) && d.ymetrikaEvent) {
                    ...
                    if ("params" === m.type && m.data) {
                        m.sended || (m.sended = []);
                        if (m.counter)
                            this.counter && this.counter.params && this.counterId == m.counter && (this.onCookies(function(a) {
                                this.counter.params(a.data)
                            }, this, e.mixin({}, m)),
                            m.sended.push(this.counterId));
                        else
                            this.onCookies(function(a) {
                                e.forEachKey(this.globalConfig.get("counters"), function(b, c) {
                                    var d = b.split(":")[0];
                                    !e.inArray(a.sended, d) && c && c.params && (c.params(a.data),
                                    a.sended.push(d))
                                }, this)
                            }, this, e.mixin({}, m));
    ...
    var Pb = {
        ...
        addAsyncItem: function(a, b, c, d, f) {
            ...
            g.flushAsync(!0)) : n.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = n.getMs(),
            g.flushAsync()) : this.timeout || (this.timeout = e.setTimeout(function() {
                g.rest = n.getMs();
                g.flushAsync();
                g.timeout = !1
            }, this.restTime))
      ...
      , da = E.inherit({
        ...
        handle: function() {
            ...
            if (!this.enabled && ("0" === h || r.isSafariWebView() || r.isAndroidWebView() || e.inArray(Qb, g.location.href.split("?")[0]) || !X() || f.read("yandex_login") || this.disable))
                return f.read("yandex_login") ? this.trigger("GDPR-skip-login") : X() ? "0" === h ? this.trigger("GDPR-skip") : r.isSafariWebView() || r.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"),
                this.realise(p, b);
            this.globalConfig.set(this.globalKey, function(a, c) {
                ...
                b.size + d < k.MAX_SIZE ? (b.push(a),
                b.size += d) : e.warning("GDPR buffer is exceeded")
            });
            a.hit(function(a) {
                if (a.params.eu || l || k.enabled)
                    ...
                    k.frameConnector.isIframe) {
                        k.frameConnector.sendToParents({
                            ...
                            var d = !1;
                            clearTimeout(g);
                            c[0].isYandex ? (k.trigger("GDPR-frame-ya"),
                        ...
                        k.askGDPR(h, d, c, p, b, f);
                else
                    return a.params.eu ? k.trigger("GDPR-skip-eu-na") : k.trigger("GDPR-eu-skip"),
                    k.realise(p, b)
            })
        }
    });
    ...
    var Rb = {
        init: function(a, b, c) {
            "22663942" == c && (c = h.createElement("img"),
    ...
    r.isPrivate = u(function(a) {
        ...
        a = e.bind(a, null, 1);
        if (e.isFunction(g.webkitRequestFileSystem) && !r.isAndroid())
            return g.webkitRequestFileSystem(0, 0, b, a);
        if (r.isFF())
            return "undefined" == typeof navigator.serviceWorker;
        if (r.isSafari() && e.isFunction(g.openDatabase))
            try {
                g.openDatabase(null, null, null, null),
                b()
            } catch (c) {
                a()
            }
        else {
            if (g.indexedDB || !g.PointerEvent && !g.MSPointerEvent)
                return b();
            a()
        }
    }, "isPrivate");
    ...
    R.log = u(function() {
        ...
        g.console && console.log && this._check() && (R.enabled = !0,
    ...
    var Sb = K.inherit({
      ...
      , Tb = E.inherit({
        ...
        _initComponent: function() {
            ...
            if (this.ignoreTags)
                for (a = 0; a < this.ignoreTags.length; a++)
                    this.ignoreTags[a] && e.mergeArrays(this._ignoreTags, [String(this.ignoreTags[a]).toUpperCase()]);
            this._cacheTags = {};
            a = 59;
        ...
        start: function() {
            if (!this._start)
                l.on(h, "click", this._handler, this);
            this._start = !0
        },
        stop: function() {
        ...
        _isTrackingClick: function(a) {
            var b;
            if (g.ymDisabledClickmap || e.isMetrikaPlayer() || !a.el)
                return !1;
            var c = a.el.tagName;
        ...
        _getElPath: function(a) {
            for (var b = ""; a && a.parentNode && "BODY" != a.tagName && "HTML" != a.tagName; )
                ...
                b += p.getElementNeighborPosition(a) || "",
                a = a.parentNode;
      ...
      , Na = E.inherit({
        ...
        checkAssessor: function() {
            ...
            e.forEachKey(b, function(c) {
                if ((new RegExp(c)).test(g.location.hash) || H.get(this.ASSESSOR_COOKIE + c))
                    H.set(this.ASSESSOR_COOKIE + c),
                    a.push(b[c])
            }, this);
            return a
        },
        ...
        _buildRemoteIframe: function(a) {
            ...
            if (c) {
                ...
                g._ym__remoteIframeContainer = b) : (c.appendChild(d),
                g._ym__remoteIframeContainer = d)
            }
        },
        ...
        _onMessage: function(a) {
            ...
            b && this._isAllowedOrigin(b) && (b = Y.parse(a.data)) && "appendremote" === b.action && this._isAllowedStatic(e.parseUrl(b.domain).host) && this._isAllowedLang(b.lang) && !this._executedMsgs[b.id] && (this._executedMsgs[b.id] = !0,
    ...
    var Vb = {
        ...
        checkChildrenData: function(a, b) {
            e.arrayEvery(this.dataToSend.childs, function(c) {
                -1 == e.arrayIndexOf(c.tryTo, b.counterId) && (c.tryTo.push(b.counterId),
                e.mixin(c.data, {
            ...
            if (f && f.substring && f.substring(0, this.nameSpace.length) == this.nameSpace) {
                ...
                if ((d = d.data) && d.type && this.handlers[d.type] && "0" === b[this.DIR_INDEX]) {
                    if (!d.toCounter || d.toCounter === this.counterId) {
                        ...
                        d.counterId && this.checkFrame(a.source) && (g = this.trigger(d.type, a, d),
                        a.source.postMessage(this.genMessage(g, [b[0], b[1], d.counterId]).string, "*"))
                    }
                } else
                    b[this.DIR_INDEX] == this.counterId && e.isArray(d) && e.arrayEvery(d, function(a) {
                        return a.counterId && a.hid
                    }) && (a = this.pending[[b[0], b[1]].join(this.spliter)]) && a.apply(this, d)
            }
        }
    }), L = z(), Ha = n.getTimezone(), Ia = n.getTimestamp(), V = g.screen, Kb = 64, Ka = r.isIE() ? 512 : 2048, Lb = r.isIE() ? 512 : 2048, Va = r.isIE() ? 100 : 400, rb = 100, fb = "noindex", ub = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i, Wb = +new Date, hb, Xa, sa = function() {
        return "1728"
    }();
    ...
    g.Ya.Metrika = function(a, b, c, d) {
        ...
        return u(function() {
            function q(a) {
                ...
                if ((new RegExp("^https?://" + L.host + "/")).test(b))
                    return !1;
                var f = a.patterns;
                for (c = 0; c < f.length; c++) {
                    ...
                    if (b.match(g))
                        ...
                        g.length) {
                            ...
                            for (d = 0; d < g.length; d++)
                                if (k == e.safeDecodeURIComponent(g[d]))
                                    return !0
                        } else
                            return !0
                }
                    ...
                    for (d = 0; d < a.length; d++) {
                        ...
                        if ("#" == g) {
                            if (g = h.getElementById(e))
                                c = !0,
                                b && Ea.unshift([g, g.innerHTML]),
                                g.innerHTML = f
                        } else if ("." == g)
                            for (g = p.getElementsByClassName(e),
                            e = 0; e < g.length; e++) {
                                c = !0;
                                var k = g[e]
                                  , l = f;
            ...
            function x(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ? e.safeDecodeURIComponent(d) : Ta.decode(N.decode(d.replace(/[-*_]/g, function(a) {
                    return {
                        "*": "+",
                        "-": "/",
                        _: "\x3d"
            ...
            function E() {
                ...
                K.retransmit(v);
                ya && Rb.init(ya, Z, a);
                v.get("pri") != A || r.isAndroidWebView() || (v.setSafe("pri", null),
                r.isPrivate(u(function(a) {
                    v.set("pri", a)
                }, "privCb")));
                Va.init(xa);
                if (v.get("hitParam")[U]) {
                    if (1 != c || v.get("counters")[U])
                        return !1;
                    n = !0
                }
                v.get("counters")[U] = f;
                            ...
                            callback: function(w, P) {
                                ...
                                if (!f.isDestructing()) {
                                    ...
                                    if (r) {
                                            ...
                                            if (J && J.length)
                                                for (W = 0; W < J.length; W++) {
                                                    ...
                                                    if ("ref" == u.type)
                                                        ...
                                                        if (t && u && u.length && (t = !1,
                                                        ba = ba || D && D.campaign || qa && qa.campaign))
                                        ...
                                        J = p.read("mp2_track");
                                        r = r.substs && r.substs[J];
                                        J && r ? (p.create("mp2_substs", e.toJSON(r)),
                                        p = m(r),
                                        f.params("__ym", p ? "mp_trackid" : "mp_trackid_bad", J)) : k()
                                    } else
                                        k();
                ...
                0 != e.keys(y).length && (Na && Na.initUserLayer(),
                y.enableAll ? (T(!0),
                ia(!0),
                X()) : (y.clickmap && ia(y.clickmap),
                y.trackLinks && T(y.trackLinks),
                y.accurateTrackBounce && X(y.accurateTrackBounce)),
                y.triggerEvent && e.async(function() {
            ...
            function ca(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !p.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        var h = mb(a);
                        h = c === h ? "" : h;
                        if (p.classNameExists(a, "ym-external-link"))
                            I.sendClickLink({
                                url: c,
                                title: h,
                                modes: d
                            ...
                            d.dl = ub.test(g) || ub.test(c) || nb(c, oa) || nb(g, oa);
                            b = b.hostname;
                            ...
                            La.set("pai", d.pai),
                            h && h !== c && La.set("il", e.trim(h, rb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = fb,
                            I.sendClickLink({
                                url: c,
                                title: h,
                                modes: d
            ...
            function fa(a, b) {
                ...
                function f(a) {
                    ...
                    for (b = 0; b < t.length; b += 3)
                        if (a)
                            l.on(t[b], t[b + 1], t[b + 2], {
                                name: "tabTrack"
                            });
                        else
                            l.un(t[b], t[b + 1], t[b + 2])
                }
                var k = !1
                  , n = !1
                  , w = !0
                  ...
                  , q = !1;
                if (r.isIE())
                    e.setTimeout(a, b, "trackUserTime");
                else {
            ...
            function X(b) {
                ...
                if (!f._isAccurateTrackBounce) {
                    ...
                    ((e = e.get("lastHit")) && (!g || g < e - 18E5) || !Eb(c, d) || .1 > Math.random()) && fa(function() {
                        f.notBounce()
                    }, b)
                }
            }
            ...
            function Ba(a) {
                if (!1 === a)
                    aa && ("onhashchange"in g ? l.un(g, "hashchange", ra) : e.clearTimeout(Ma),
                    aa = !1);
                else if (a = ra,
                !aa) {
            ...
            function ta(a, b, c) {
                ...
                a && (b.push(a),
                c = c || {},
                e.isFunction(c.callback) && (b.push(c.callback),
                c.ctx && b.push(c.ctx)));
                b.length && f.params.apply(f, b)
            }
            var Ca = "", y = {}, va = "", wa = Ua.lastReferrer = L.href, xa = 0, Da = !1, G;
            v.setSafe("counter", f);
            Sa && u(function() {
                throw Sa.error;
            }, "include." + Sa.scope)();
            ...
            if (!g["disableYaCounter" + a]) {
                ...
                var U = a + ":" + c;
                if (v.get("counters")[U])
                    return R.log("Duplicate counter " + U + " initialization"),
                    v.get("counters")[U];
                var Z = v.get("hitId");
                var na = new tb({
                    counterId: a,
                ...
                var Va = {
                    init: function(a, b) {
                        if (g.performance && "function" === typeof performance.getEntries && (a === A && (a = 1),
                        !(Math.random() >= a))) {
                            var c = {
                                1882689622: 1,
                                2318205080: 1,
                ...
                f.hit = t(function(b, c, d, g, h, k) {
                    (b = b && e.isFunction(b.toString) ? b.toString() : !1) ? (e.isObject(c) && (d = c.referer,
                    g = c.params,
                    h = c.callback,
                    k = c.ctx,
                    c = c.title),
                    D = b,
                    R.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", g),
                    I.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: Da,
                ...
                f.addFileExtension = t(function(a) {
                    if (!a)
                        return e.warning("Empty extension"),
                        f;
                ...
                var Wa = {
                    ...
                    parseValidate: function(a, b) {
                        ...
                        for (d in b)
                            b.hasOwnProperty(d) && -1 === e.arrayIndexOf(this.requiredEcommerceFields, d) && (c[a].actionField || (c[a].actionField = {}),
                ...
                f.destruct = t(function() {
                    ...
                    try {
                        ...
                        delete v.get("counters")[U],
                        delete v.get("hitParam")[U]
                    } catch (P) {}
                });
                ...
                if (a) {
                    ...
                    if ("prerender" === h.webkitVisibilityState || "prerender" === h.visibilityState) {
                        ...
                        var kb = function() {
                            "prerender" !== h.webkitVisibilityState && "prerender" !== h.visibilityState && (l.un(h, "webkitvisibilitychange,visibilitychange", kb),
                            V(!0))
                        };
